            ...
            <div class="flex flex-wrap gap-4">
                <div class="flex-1 w-128">
                    <div class="p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <hr class="p-2"></hr>
                        <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">#39 JakartaJS November Meetup with Kumparan</p>
                ...
                <div class="flex-1 w-64">
                    <div class="p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <hr class="p-2"></hr>
                        <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">#39 JakartaJS Oktober Meetup with Kumparan</p>
                ...
                <div class="flex-1 w-32">
                    <div class="p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <hr class="p-2"></hr>
                        <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">#39 JakartaJS September Meetup with Kumparan</p>
