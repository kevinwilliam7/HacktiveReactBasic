	...
	return (
		<div className='mb-auto h-full flex flex-col'>
			<div>
				...
				<div id='education' className='grid md:grid-cols-1 sm:grid-cols-1 xl:grid-cols-1 gap-4 justify-start h-full max-w-screen-2xl mx-auto pt-10 pb-10 pl-10 pr-10'>
					<ol class="relative border-l border-gray-200 dark:border-gray-700">
						{
							listExperience.map(data => {
								return <li class="mb-10 ml-6">            
									...
									<h3 class="flex items-center mb-1 text-lg font-semibold text-gray-900 dark:text-white">{data.name} <span class="bg-blue-100 text-blue-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-blue-900 dark:text-blue-300 ml-3">{data.status==='Latest' ? 'Latest' : 'Planning'}</span></h3>
